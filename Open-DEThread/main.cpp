...
=======
PROJECT_BRIEF          = "Open-DE nace a partir de la necesidad de generar un entorno de trabajo más recreativo y agradable, haciendo que nuestro escritorio tenga un fondo de pantalla animado. Ya existen competencias enfocadas en sistemas windows, mas nuestra solución brinda soporte a sistemas linux con diferentes entornos de escritorio."

# With the PROJECT_LOGO tag one can specify a logo or an icon that is included
# in the documentation. The maximum height of the logo should not exceed 55
# pixels and the maximum width should not exceed 200 pixels. Doxygen will copy
# the logo to the output directory.
>>>>>>> 5b37ddc07f219c220ee4995f2e782c7b33d7d821
